<!DOCTYPE html>
    ...
    <meta charset="utf-8">
    <title>DREAM'S N MOTION Formations</title>
		...
		<div class="element-title">
			<div class="row">
				<div class="container">
					...
					<h1 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="300ms"></h1>
					<h3 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="300ms"> <span class="main-color"> </span></h3>
				</div>
			</div>
		</div>
		<!-- End Block Title -->
				...
				<div class="row">
						...
						<div class="news-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="300ms">
							<div class="entry-header">
								<div class="blog-image">
									<a href="formation1.php"><img alt="" src="images/blog/Capture.PNG" class="img-responsive"></a>
								</div>

							</div>
							<div class="entry-content">
								<h3 class="entry-title">
									<a href="formation1.php">Langues vivantes</a>
								</h3>
					...
					<div class="col-lg-6 col-sm-6">
						<div class="news-content wow fadeInRight" data-wow-duration="1s" data-wow-delay="300ms">
							<div class="entry-header">
								<div class="blog-image">
									<a href="formation2.php"><img alt="" src="images/blog/c2.PNG" class="img-responsive"></a>
								</div>

							</div>
							<div class="entry-content">
								<h3 class="entry-title">
									<a href="formation2.php"> Le domaine technique </a>
								</h3>
				...
				<div class="row">
					<div class="col-lg-6 col-sm-6">
						<div class="news-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="600ms">
							<div class="entry-header">
								<div class="blog-image">
									<a href="formation3.php"><img alt="" src="images/blog/téléchargement.jpg" class="img-responsive"></a>
								</div>

							</div>
							<div class="entry-content">
								<h3 class="entry-title">
									<a href="formation3.php">L'informatique</a>
								</h3>
						...
						<div class="news-content wow fadeInRight" data-wow-duration="1s" data-wow-delay="600ms">
							<div class="entry-header">
								<div class="blog3-image">
									<a href="formation4.php"><img alt="" src="images/blog/Capture3.PNG" class="img-responsive"></a>
							...
							<div class="entry-content">
								<h3 class="entry-title">
									<a href="formation4.php"> Soft skills</a>
								</h3>
