<!DOCTYPE html>
    ...
    <meta charset="utf-8">
    <title>DREAM'S N MOTION evaluez vos compétences</title>
			...
			<div class="row">
				<div class="container">
					<div class="section-title wow fadeInDown">
						<h1><span>Evaluer vos competence</span></h1>
					</div>
				...
				<div class="row">
						...
						<div class="news-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="300ms">
							<div class="entry-header">
								<div class="blog-image">
									<a href="evaluation.fr.php" target="_blank"><img alt="" src="images/fran.JPEG" class="img-responsive"></a>
								</div>

							</div>
							<div class="entry-content">
								<h3 class="entry-title">
									<a href="evaluation.fr.php" target="_blank">français</a>
								</h3>
					...
					<div class="col-lg-6 col-sm-6">
						<div class="news-content wow fadeInRight" data-wow-duration="1s" data-wow-delay="300ms">
							<div class="entry-header">
								<div class="blog-image">
									<a href="evaluation.en.php" target="_blank"><img alt="" src="images/ang.JPG" class="img-responsive"></a>
								</div>

							</div>
							<div class="entry-content">
								<h3 class="entry-title">
									<a href="evaluation.en.php" target="_blank"> Anglais</a>
								</h3>
...
<div class="bottom-footer">
	<div class="container">
		<div class="bottom-footer-center wow fadeInDown" data-wow-duration="1s" data-wow-delay="300ms">
			...
			<h4 style="color: #040433"><b>Adresse :</b> <u>R.L. Senghor, Imm Majestic Palace SFAX
3000 Sfax</u></h4>
		</div> 
		...
		<!--<div class="bottom-footer-left wow fadeInUp" data-wow-duration="1s" data-wow-delay="600ms">
			<p><span>&#169; Copyrights 2020 © :  <a href="https://www.enetcomje.com/">ENET'COM Junior Entreprise</a></p>
		</div>-->		  
	</div>
</div>
<!-- End Footer -->
