...
<!-- End Slider -->
	...
	<h1 style="font-size: 40px;font-weight: bold;color:lightslategray">CONTACTEZ NOUS</h1>
	<div class="container">
		<div class="row">	
					...
					<div class="row">
						<div class="wrapper-contacts-icons">	
							<div class="col-xs-4 wow fadeInRight" data-wow-duration="1s" data-wow-delay="300ms">	
								...
								<div class="">sfax-tunisie</div>
								<div class=""> Beb Bhar Sfax</div>
							</div>								
							<div class="col-xs-4 wow fadeInRight" data-wow-duration="1s" data-wow-delay="450ms">	
								<i class="fa fa-mobile-phone"></i>
								<div class="">jeudi - mercredi 09:00 18:00</div>
								<div class="">(+216) 53 635 200 | 70 033 587</div>
							</div>
							<div class="col-xs-4 wow fadeInRight" data-wow-duration="1s" data-wow-delay="600ms">	
								<i class="fa fa-envelope-o"></i>
								<div class="">envoyer un courriel</div>
								<div class="">www.dreams-motion.com</div>
							</div>								
						</div>
					</div>
				</div>
...
<br>
<br>							
    <p><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3278.9405100795493!2d10.759783815189701!3d34.7318938804265!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x13002d2c201a1547%3A0x860c306efa1547b!2sCENTRE%20DE%20FORMATION%20DREAMS%20N%20MOTION%20TUNISIA!5e0!3m2!1sfr!2stn!4v1581629266335!5m2!1sfr!2stn" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe></p>
<!-- Contacts -->	
	<div class="contacts"> 
			...
			<div class="row">	 		
				<div class="container">
					<div class="section-title wow fadeInDown" data-wow-duration="1s" data-wow-delay="300ms">			
						<h1><span>Formulaire</span></h1>
						<p>Pour toutes informations supplémentaires, vous pouvez nous contacter à travers le formulaire ci dessous.</p>							
					</div>				
						...
						<div class="row wow fadeInRight" data-wow-duration="1s" data-wow-delay="800ms">
							...
							<form id="contact-form">
								<div class="col-lg-6 col-sm-6">				
									...
									<div class="form-group">
										<input type="text" name="subject" class="form-control" placeholder="Matière">
									</div>
								</div>
								<div class="col-lg-6 col-sm-6">				
									<div class="form-group">
										<textarea  name="message" class="form-control" placeholder=" Mettez votre description" rows="8"></textarea>
									</div>
									<div id="output"></div>
									<input type="submit" class="" value="Submit" style="background-color: deepskyblue;">
								</div>
							</form>
							<!-- End contact-form -->
						</div>
...
<div class="bottom-footer">
	...
	<div class="bottom-footer-center wow fadeInDown" data-wow-duration="1s" data-wow-delay="300ms">
		...
		<div class="bottom-footer-left wow fadeInUp" data-wow-duration="1s" data-wow-delay="450ms">
            <p style="font-size:90%;"> Copyright 2020 <a href="https://www.enetcomje.com/">ENET'COM Junior Entreprise</a></p>	
		</div>		  
	</div>
</div>
<!-- End Footer -->	
